...
@NgModule({ // @NgModule is used to declare everything that you create
   imports: [
      BrowserModule,
      ClarityModule,
      HttpClientModule,
   ...
   providers: [ChassisService, ModalConfigService, ResourceService, HostsService], // Services will go here
